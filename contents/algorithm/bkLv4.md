...
summary: '이 게시글은 백준 1차원 배열 단계 중 1번부터 10번에 해당하는 문제를 JavaScript(NodeJS)언어로 풀이 방법에 대한 내용입니다. 배열을 사용합니다 '
thumbnail: '../baekjoon.jpeg'
---

> 백준 반복문 단계에 중 1번부터 10번에 해당하는 문제에 대한 풀이입니다. 사용한 언어는 **_JavaScript(NodeJS)_** 입니다.
